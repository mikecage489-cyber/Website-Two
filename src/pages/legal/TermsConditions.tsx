          ...
          <div className="bg-white rounded-lg shadow-md p-8 space-y-6">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                You may use our tools for lawful purposes only. You agree to use the services in
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                <li>Use our tools for any illegal purpose or in violation of any laws</li>
                <li>Attempt to interfere with or disrupt our services</li>
                <li>Use automated systems to access our tools in a way that sends more requests
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                uninterrupted, error-free, or completely secure. We make no guarantees about the
                accuracy, reliability, or completeness of any content or results from our tools.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4 mt-2">
                ...
                <li>Any errors or omissions in any content or results</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                While we don't store the content you process using our tools, if you provide any
                feedback or suggestions, you grant us the right to use that feedback without any
                obligation to you.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                While we strive to provide accurate results from our tools, we cannot guarantee
                100% accuracy. Users should verify important calculations and results independently.
                We are not responsible for any decisions made based on results from our tools.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                the content, privacy policies, or practices of any third-party sites. Your use of
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                Advertisers are responsible for ensuring their ads comply with applicable laws.
                We are not responsible for the content of advertisements or the practices of
                advertisers.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                any modification, suspension, or discontinuation of our services.
              </p>
            </section>
